...
const About = () => {
  const skills = [
    { category: 'Frontend', items: ['React', 'Vue.js', 'Angular', 'TypeScript', 'Next.js'] },
    ...
    <section className="py-20 px-6 max-w-7xl mx-auto">
      <div className="text-center mb-16">
        ...
        <div className="text-matrix-green/80 text-lg max-w-3xl mx-auto font-code">
          ...
          <p className="ml-8 mb-2">
            passion: <span className="text-white">"Создание инновационных решений"</span>,
          </p>
          <p className="ml-8 mb-2">
        ...
        {skills.map((skillGroup, index) => (
          <div key={index} className="project-card p-6 rounded-lg">
            <div className="flex items-center mb-4">
              <Icon name="Terminal" className="text-matrix-green mr-3" size={24} />
            ...
            <div className="space-y-2">
              {skillGroup.items.map((skill, skillIndex) => (
                <div key={skillIndex} className="flex items-center">
                  ...
                  <span className="text-matrix-green/80 font-code">{skill}</span>
                </div>
              ))}
            </div>
          </div>
